 ...
 * single-page HTML dashboard for codeprobe analysis results.
 */
...
<title>codeprobe dashboard &mdash; ${escapeHtml(data.projectName)}</title>
<style>
...
<div class="container">
  ...
  <!-- Header -->
  <div class="header">
    <h1><span>codeprobe</span> dashboard</h1>
  ...
  <!-- Footer -->
  <div class="footer">
    Generated by <a href="https://github.com/anthropics/codeprobe">codeprobe</a> &mdash; DevTools for AI Coding
  </div>
